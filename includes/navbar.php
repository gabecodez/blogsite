...
<nav class="navbar homepage" id="navbar" aria-label="Main Navigation">
    <div class="navbar-indent">
        ...
        <ul class="navbar-menu">
            ...
            <li class="navbar-item dropdown">
                <a href="https://www.blueskyhomesteading.com/shop" class="nav-link dropdown-toggle" aria-haspopup="true" aria-expanded="false">Shop <svg style="vertical-align: middle;" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="black">
                        <path d="M200-200v-400h80v264l464-464 56 56-464 464h264v80H200Z" />
                    </svg></a>
                <ul class="dropdown-menu">
    ...
    <div class="mobile-nav-panel" id="mobile-nav-panel">
        ...
        <ul>
            ...
            <li><a href="https://www.blueskyhomesteading.com/shop">Shop</a>
                <ul>
                    <li><a href="https://www.blueskyhomesteading.com/shop/skincare"><svg style="vertical-align: middle;" xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="black">
                                <path d="m576-192-51-51 129-129H240v-444h72v372h342L525-573l51-51 216 216-216 216Z" />
                            </svg> Skincare</a></li>
                    <li><a href="https://www.blueskyhomesteading.com/hardware"><svg style="vertical-align: middle;" xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="black">
                                <path d="m576-192-51-51 129-129H240v-444h72v372h342L525-573l51-51 216 216-216 216Z" />
                            </svg> Hardware and Tools</a></li>
                    <li><a href="https://www.blueskyhomesteading.com/antiques"><svg style="vertical-align: middle;" xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="black">
                                <path d="m576-192-51-51 129-129H240v-444h72v372h342L525-573l51-51 216 216-216 216Z" />
                            </svg> Antiques</a></li>
                </ul>
            </li>
